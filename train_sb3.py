...
def main():
    ...
    model = PPO('MlpPolicy', n_steps=1024, batch_size=128, learning_rate=0.00025, env=train_env, verbose=1, device='cpu') #learning_rate=0.00025
    model.learn(total_timesteps=int(2000000)) # total_timesteps=int(1e10)
